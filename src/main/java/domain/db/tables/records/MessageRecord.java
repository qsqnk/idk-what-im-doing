...
public class MessageRecord extends UpdatableRecordImpl<MessageRecord> implements Record4<Long, String, String, Long> {
    ...
    @Override
    public MessageRecord values(Long value1, String value2, String value3, Long value4) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public MessageRecord(Long id, String sender, String content, Long chatId) {
        super(Message.MESSAGE);
